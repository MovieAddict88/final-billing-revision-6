...
?>
	<div class="dashboard">
		...
		<div class="col-md-6"><h4><a href="bills.php" class="btn btn-sm btn-primary">  Back</a> Paid bills for Every Month</h4></div>
		<div class="col-md-6">
		...
		<table class="table table-striped table-bordered">
				<thead class="thead-inverse">
				  <tr class="info">
				    ...
				    <th style="background-color: #284390; color: white;">Disconnection</th>
				    <th style="background-color: #284390; color: white;">Transaction</th>
				  </tr>
				</thead>
			  <tbody>
			  <?php
  ...
  <script>
    function getTracsaction(id) {
		let left = (screen.width/2)-(600/2);
  	    let top = (screen.height/2)-(800/2);
		let params = `scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no,width=600,height=800,left=${left},top=${top}`;
		open('payment_transaction.php?customer='+id, 'Payment Transaction !', params)
		}
    </script>