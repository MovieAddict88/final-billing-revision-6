...
<div class="col-md-12 col-sm-12">
	<div class="panel panel-default">
		<div class="panel-heading">
		<h4>Balance :  <a href="expanse.php" class="btn btn-default btn-sm "> Get all History </a><?php if (isset($msg)) {echo "$msg";} ?></h4>
		</div>
		<div class="panel-body">
			<div class="col-md-12">
				<form class="form-inline" action="expanse.php" method="POST">
					...
					<button type="submit" class="btn btn-primary">Balance</button>
				</form>
				<br>
			<div class="table-responsive">
