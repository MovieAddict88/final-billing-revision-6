            ...
            foreach ($customers as $customer){
				...
				<tr>
					...
					<td>
						...
						<button type="button" class="btn btn-primary btn-sm btn-action remark-btn" data-customer-id="<?=$customer->id?>" data-remarks="<?php echo htmlspecialchars($customer->remarks ?? '', ENT_QUOTES); ?>">REMARK</button>
						<?php
