...
<head>
	...
	<title>TYPE | Cornerstone</title>
</head>
<body>
<div class="container">
    <div class="row">
        <br>
        <button class="btn btn-success" data-toggle="modal" data-target="#add_package">Add new Type</button>
    ...
    <div class="message">Do not delete type.</div>
</div>
	<!-- New modal -->
